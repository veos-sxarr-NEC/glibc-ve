...
/* Changes by NEC Corporation for the VE port, 2023 */
...
void *
__mmap_ve64 (void *addr, size_t len, int prot, uint64_t flags, int fd, off64_t offset)
{
...
weak_alias (__mmap_ve64, mmap_ve64)
libc_hidden_def (__mmap_ve64)

#ifdef __OFF_T_MATCHES_OFF64_T
weak_alias (__mmap_ve64, mmap_ve)
weak_alias (__mmap_ve64, __mmap_ve)
libc_hidden_def (__mmap_ve)
#endif
