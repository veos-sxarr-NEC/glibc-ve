...
${run_program_env} LANG= LC_ALL=invalid-locale VE_LOCPATH=does-not-exist \
...
/bin/bash: warning: setlocale: LC_ALL: cannot change locale (invalid-locale): No such file or directory
...
warning: The VE_LOCPATH variable is set to "does-not-exist"
EOF
