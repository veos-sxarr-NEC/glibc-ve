...
/* #1410 */
extern void *__mmap_ve (void *__addr, size_t __len, int __prot,
                     __uint64_t __flags, int __fd, __off_t __offset);
libc_hidden_proto (__mmap_ve)
extern void *__mmap_ve64 (void *__addr, size_t __len, int __prot,
                       __uint64_t __flags, int __fd, __off64_t __offset);
libc_hidden_proto (__mmap_ve64)
